...
func (f *FriendRpcClient) GetFriendsWithIDs(ctx context.Context, ownerUserID string, userID []string) (*friend.GetSpecifiedFriendsInfoResp, error) {
	r, err := f.Client.GetFriendsInfo(ctx, &friend.GetSpecifiedFriendsInfoReq{OwnerUserID: ownerUserID, UserIDList: userID})
	if err != nil {
		return nil, err
	}
	return r, nil
...
func (f *FriendRpcClient) GetFriendsRemark(ctx context.Context, ownerUserID string) (*friend.GetFriendsRemarkResp, error) {
	r, err := f.Client.GetFriendsRemark(ctx, &friend.GetFriendsRemarkReq{OwnerUserID: ownerUserID})
	if err != nil {
		return nil, err
	}
	return r, nil

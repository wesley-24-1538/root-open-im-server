...
func TestName(t *testing.T) {
	...
	var groupMemberCache *sdkws.GroupMemberFullInfo
	msgs, err := db.getMsgBySeqsRange(context.Background(), "4931176757", "si_3866692501_4931176757", seqs, seqs[0], seqs[len(seqs)-1], userInfo, groupMemberCache)
	if err != nil {
		t.Fatal(err)
	}

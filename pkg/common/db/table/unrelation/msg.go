...
type MsgDocModelInterface interface {
	...
	GetMsgByConversationId(ctx context.Context, userID, conversationID string, conversationType int32, startSeq, endSeq int64, userAuth int, roleLevel int32) ([]*MsgInfoModel, error)
	...
	MsgIdGetConversations(ctx context.Context, req *msg.MsgIdGetConversationsReq) (map[string]string, error)
	MsgIdGetConversationSeq(ctx context.Context, req *msg.MsgIdGetConversationSeqReq) (*msg.MsgIdGetConversationSeqResp, error)
	RangeUserSendCount(
		ctx context.Context,
		start time.Time,
		end time.Time,

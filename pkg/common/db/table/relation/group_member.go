...
type SearchGroupMemberModel struct {
	GroupID   string    `bson:"group_id"`
...
type GroupMemberModelInterface interface {
	...
	TakeAll(ctx context.Context, groupID string) (groupMember []*GroupMemberModel, err error)
	...
	SearchMemberSorted(ctx context.Context, keyword string, groupID string, pagination pagination.Pagination) (total int64, groupList []*GroupMemberModel, err error)
	SearchGroupMembers(ctx context.Context, keyword string, userID string, groupID []string, pagination pagination.Pagination) (total int64, groupMembers []*SearchGroupMemberModel, err error)

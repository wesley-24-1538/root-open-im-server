...
type UserCache interface {
	...
	GetUsersInfoWaitGroup(ctx context.Context, userIDs []string) ([]*relationtb.UserModel, error)
...
func (u *UserCacheRedis) GetUsersInfoWaitGroup(ctx context.Context, userIDs []string) ([]*relationtb.UserModel, error) {
	return batchGetCacheWaitGroup(ctx, u.rcClient, u.expireTime, userIDs, func(userID string) string {
		return u.getUserInfoKey(userID)
	}, func(ctx context.Context, userID string) (*relationtb.UserModel, error) {
		return u.userDB.Take(ctx, userID)
	})

...
type GroupCache interface {
	...
	GetAllGroupMembersInfoWaitGroup(ctx context.Context, groupID string) (groupMembers []*relationtb.GroupMemberModel, err error)
...
func (g *GroupCacheRedis) GetGroupMembersInfo(ctx context.Context, groupID string, userIDs []string) (groupList []*relationtb.GroupMemberModel, err error) {
...
func (g *GroupCacheRedis) GetGroupMembersInfoWaitGroup(ctx context.Context, groupID string, userIDs []string) (groupList []*relationtb.GroupMemberModel, err error) {
	return batchGetCacheWaitGroup(ctx, g.rcClient, g.expireTime, userIDs, func(userID string) string {
		return g.getGroupMemberInfoKey(groupID, userID)
	}, func(ctx context.Context, userID string) (*relationtb.GroupMemberModel, error) {
		return g.groupMemberDB.Take(ctx, groupID, userID)
	})
...
func (g *GroupCacheRedis) GetAllGroupMembersInfoWaitGroup(ctx context.Context, groupID string) (groupMembers []*relationtb.GroupMemberModel, err error) {
	groupMemberIDs, err := g.GetGroupMemberIDs(ctx, groupID)
	if err != nil {
		return nil, err
	}

	return g.GetGroupMembersInfoWaitGroup(ctx, groupID, groupMemberIDs)
}

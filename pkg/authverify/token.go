...
func CheckUserIDIsAdmin(userID string) bool {
	return utils.IsContain(userID, config.Config.Manager.UserID) || utils.IsContain(userID, config.Config.IMAdmin.UserID)
}

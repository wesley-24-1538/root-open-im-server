...
var (
	...
	ErrMsgSensitiveWordFailed = NewCodeError(MsgSensitiveWordFailed, "MsgSensitiveWordFailed")
...
func GetSendMsgLimitErr(err string) error {
	return NewCodeError(MsgSendLimit, err)
}

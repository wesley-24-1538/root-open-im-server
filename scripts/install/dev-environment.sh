...
# Zookeeper的地址
readonly ZOOKEEPER_ADDRESS=${ZOOKEEPER_ADDRESS:-"mse-655567614-zk.mse.aliyuncs.com"}
...
###################### Object 配置信息 ######################
# app要能访问到此ip和端口或域名
readonly API_URL=${API_URL:-"https://openim-api.88zb3355.com"}
...
# MinIO的端点URL
def MINIO_ADDRESS "172.31.13.45"
...
readonly MINIO_SIGN_ENDPOINT=${MINIO_SIGN_ENDPOINT:-"https://oss.88zb3355.com"} # signEndpoint为minio公网地址
def "MINIO_PUBLIC_READ" "true"                                                   # 公有读
...
# Redis的地址
def "REDIS_ADDRESS" "r-j6ch262r648gqgstr8.redis.rds.aliyuncs.com"

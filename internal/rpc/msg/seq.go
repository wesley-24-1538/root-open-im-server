...
func (m *msgServer) GetMinSeqs(ctx context.Context, req *pbmsg.GetMinSeqsReq) (*pbmsg.SeqsInfoResp, error) {
	minSeqs, err := m.MsgDatabase.GetMinSeqs(ctx, req.ConversationIDs)
	if err != nil {
		return nil, err
	}
	return &pbmsg.SeqsInfoResp{MinSeqs: minSeqs}, nil
}

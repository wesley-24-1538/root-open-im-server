...
func (o *GroupApi) GetGroupMemberPageList(c *gin.Context) {
	a2r.Call(group.GroupClient.GetGroupMemberPageList, o.Client, c)
}
...
func (o *GroupApi) GetFindGroups(c *gin.Context) {
	a2r.Call(group.GroupClient.GetFindGroups, o.Client, c)
}
func (o *GroupApi) SearchGroupMembers(c *gin.Context) {
	a2r.Call(group.GroupClient.SearchGroupMembers, o.Client, c)
}

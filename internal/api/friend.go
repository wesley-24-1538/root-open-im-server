...
func (o *FriendApi) GetFriendPageList(c *gin.Context) {
	a2r.Call(friend.FriendClient.GetFriendPageList, o.Client, c)
}
...
func (o *FriendApi) GetFriendsRemark(c *gin.Context) {
	a2r.Call(friend.FriendClient.GetFriendsRemark, o.Client, c)
}
